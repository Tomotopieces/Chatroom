...
public class AccountServiceTest {
    ...
    public void register() throws SQLException {
        ...
        try (AccountService instance = AccountService.getInstance()) {
            ...
            instance.register(zzzz.getAcc_name(), zzzz.getAcc_password());
            assertTrue(instance.match(zzzz.getAcc_name(), zzzz.getAcc_password()));
        }
    ...
    public void isExist() throws SQLException {
        ...
        try (AccountService instance = AccountService.getInstance()) {
            assertFalse(instance.isExist("Void"));
            assertTrue(instance.isExist("Tomoto"));
        }
        System.out.println("isExist test over.");
    }
}